...
#define RELAY_PIN1 8   // Pin connected to the relay
#define RELAY_PIN2 9   // Pin connected to the relay
...
void setup() {
  ...
  digitalWrite(RELAY_PIN1, HIGH);  // Initially turn off relay (assuming active LOW)
  digitalWrite(RELAY_PIN2, HIGH);  // Initially turn off relay (assuming active LOW)
...
void loop() {
  ...
  if (averageMoisture < 50) {
    ...
    digitalWrite(RELAY_PIN1, LOW);  // Turn on relay (assuming active LOW)
    digitalWrite(RELAY_PIN2, LOW);  // Turn on relay (assuming active LOW)
